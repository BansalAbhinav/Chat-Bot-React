  ...
  >
    CHAT-BOT
      ...
      <button
        ...
        className="fixed right-5 bottom-5 bg-blue-300 rounded-3xl h-10 w-10 md:h-12 md:w-12 flex cursor-pointer items-center justify-center hover:bg-blue-400 transition-colors z-50"
      >
      ...
      <div
        className={`bg-white border-2 border-blue-800 rounded-lg shadow-2xl overflow-hidden fixed right-4 md:right-[35px] bottom-20 md:bottom-[90px] transition-all duration-500 text-[#1E3A8A] z-40
          ${
